...
correlations = {
    "QB": pd.read_csv("gui_app/gui/scripts/ModelingAnalysis/PosSpecific/QB_feature_correlations.csv"),
    "RB": pd.read_csv("gui_app/gui/scripts/ModelingAnalysis/PosSpecific/RB_feature_correlations.csv"),
    "WR": pd.read_csv("gui_app/gui/scripts/ModelingAnalysis/PosSpecific/WR_feature_correlations.csv"),
    "TE": pd.read_csv("gui_app/gui/scripts/ModelingAnalysis/PosSpecific/TE_feature_correlations.csv"),
}
